...
let config = {
    ...
    // change Velo-dissi for disapperance time
    VELOCITY_DISSIPATION: 0.5,
    PRESSURE: 0.5,
    PRESSURE_ITERATIONS: 20,

    // change CURL to make it slimy
    CURL: 30,
    SPLAT_RADIUS: 0.3,
    SPLAT_FORCE: 6000,
    SHADING: false,
...
window.addEventListener('keydown', e => {
    ...
    if (e.key === ' ') {
        ...
        splatStack.push(parseInt(Math.random() * 12) + 3);
        config.SPLAT_RADIUS = 0.1
    }
